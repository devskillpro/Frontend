...
const AttarCategoryPage = () => {
  const attarProducts = featuredProducts.filter(
    (item) => item.category?.toLowerCase() === 'attar'
  );
        ...
        <ProductCard carousel={false} products={attarProducts} />
         ...
         <div className="flex flex-col items-center justify-center py-20 px-4 text-center">
          ...
          <h3 className="text-2xl font-semibold mb-2 text-gray-700">
           Attars Not Available
          </h3>
          <p className="text-gray-500 max-w-xs">
            Sorry, there are no attars available at the moment. Please check back later or explore our other great deals!
          </p>
        </div>
      )}
    </section>
